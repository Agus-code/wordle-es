...
const checkWin = (txt) => {
	...
	const letters_word = GAME_WORD_SPLIT;
	...
	const letters_painted = [];
	//validate yellow
	let values = Object.values(data);
	values.forEach((value, i) => {
		if (!value && !letters_painted.includes(GUESSED_WORD_SPLIT[i])) {
			...
			letters_painted.push(GUESSED_WORD_SPLIT[i]);
		}
	});
